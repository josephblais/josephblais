...
Hey! I am a front end facing full stack web developer pivoting from 6 years of experience in freelance work in the arts. Having recently completed the Lighthouse Labs Web Development Bootcamp, I am excited to apply the broad range of skills I have acquired to my new-found passion for web development.

Here are a few of the projects I've been working on lately. Click around! And don't hesitate to message me on [LinkedIn](https://www.linkedin.com/in/joseph-blais/) if you have any questions!
    ...
    <td width="33%" valign="top">
     <a href="https://github.com/JasmeetRangar/We.TV">
      ...
      <details>
        ...
        <br />
        <a href="https://github.com/JasmeetRangar/We.TV">
            <img src="https://raw.githubusercontent.com/JasmeetRangar/We.TV/master/client/public/readme-gifs/05-add-post.gif" width="100%" alt="We.TV"/>
        </a>
        <p><strong>Front-end:</strong> React, Axios, Material-UI</p>
        <p><strong>Back-end:</strong> Node.js, Express, Socket.io, PostgreSQL</p>
        <p><strong>API:</strong> TVMaze, Cloudinary</p>
        </details>
    </td>
    <td width="33%" valign="top">
     <a href="https://github.com/mclmnop/midterm-project">
      ...
      <br />
      <p><a href="https://github.com/mclmnop/midterm-project">Repo</a></p>
      <p>An e-commerce site that allow vendors to post ads for items and exchange messages with the buyers.</p>
      <details>
        <summary>More</summary>
        <br />
        <a href="https://github.com/mclmnop/midterm-project">
            <img src="https://raw.githubusercontent.com/mclmnop/midterm-project/master/docs/vend_welcome_page.png" width="100%" alt="VEND"/>
        </a>
        <p><strong>Front-end:</strong> HTML, Sass, jQuery, ejs, Bootstrap</p>
